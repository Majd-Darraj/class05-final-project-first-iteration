...
router.get("/", (req, res) => {
  ...
  const sql = SqlString.format(
    ...
    "SELECT * FROM events, internships where (events.event_theme_image REGEXP ?) OR (internships.internship_theme_image REGEXP ?) AND events.active = 1 AND internships.active =1",
