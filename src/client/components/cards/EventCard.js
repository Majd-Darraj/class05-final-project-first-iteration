      ...
      <div className="card-item event-item">
        <div className="card-container event-item-container">
          ...
          <article className="card-info">
            ...
            <p className="event-address">{this.props.event_address}</p>
            <p className="organisation-postal-code">
              {this.props.event_postal_code}
            </p>
            <p className="event-city">{this.props.event_city}</p>
            <p className="event-geo-lat">{this.props.event_geo_lat}</p>
            <p className="event-geo-lng">{this.props.event_geo_lng}</p>
            <p className="event-start-date">{this.props.event_start_date}</p>
            <p className="event-end-date">{this.props.event_end_date}</p>

            <p className="event-start-hour">{this.props.event_start_hour}</p>
            <p className="event-end-hour">{this.props.event_end_hour}</p>
