        ...
        <div className="card-container networking-item-container">
          <div className="card-info-container">
            ...
            <article className="card-info">
              ...
              <h2 className="sector-activity">{this.props.sector_activity}</h2>
              ...
              <p className="networking-city">{this.props.networking_city}</p>
              <p className="organisation-url">{this.props.organisation_url}</p>
