        ...
        return (
            <form onSubmit={this.submitForm}>
                ...
                <div className="col">
                    ...
                    <input className="col" name="internship_category" value={this.state.internshipData.internship_category} onChange={this.updateField} />
                </div>
                <div className="col">
                ...
                <div className="col">
                    ...
                    <input className="col" name="department" value={this.state.internshipData.department} onChange={this.updateField} rows="2"/>
                </div>
                <div className="col">
                ...
                <div className="col">
                    ...
                    <input className="col" name="travel_expenses" value={this.state.internshipData.travel_expenses} onChange={this.updateField} />
                </div>
                <div className="col">
